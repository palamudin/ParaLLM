...
def main() -> int:
    ...
    parser.add_argument("--skip-prechecks", action="store_true", help="Skip Python/PHP/JS/http prechecks.")
    ...
    if state_hash_before != state_hash_after:
        raise QAError("Interactive data/state.json changed during the isolated eval smoke.")
