...
$draft = normalize_draft_state(array_merge($existingDraft, [
    ...
    'localFilesEnabled' => post_value('localFilesEnabled', $existingDraft['localFilesEnabled']),
    'localFileRoots' => post_value('localFileRoots', $existingDraft['localFileRoots']),
    'githubToolsEnabled' => post_value('githubToolsEnabled', $existingDraft['githubToolsEnabled']),
    'githubAllowedRepos' => post_value('githubAllowedRepos', $existingDraft['githubAllowedRepos']),
    'dynamicSpinupEnabled' => post_value('dynamicSpinupEnabled', $existingDraft['dynamicSpinupEnabled']),
