...
json_response([
    ...
    'summary' => [
        ...
        'localToolCalls' => is_array($responseMeta['localToolCalls'] ?? null) ? array_slice($responseMeta['localToolCalls'], 0, 12) : [],
        'localFileSources' => array_values(normalize_string_list($responseMeta['localFileSources'] ?? [])),
        'githubToolCalls' => is_array($responseMeta['githubToolCalls'] ?? null) ? array_slice($responseMeta['githubToolCalls'], 0, 12) : [],
        'githubSources' => array_values(normalize_string_list($responseMeta['githubSources'] ?? [])),
